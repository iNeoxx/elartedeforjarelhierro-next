...
export async function TaxonomyProductType({ term }: TaxonomyProductTypeProps) {
  // 1. Obtención de productos con los filtros necesarios
      ...
      <div className="container mx-auto px-4 pt-10">
        ...
        <div className="flex flex-col items-center mb-16 space-y-2">
          ...
          <div className="flex flex-wrap justify-center items-center text-center">
            <h2 className="text-4xl md:text-6xl font-black text-[#497eda] tracking-tighter">
              Categoría:
            </h2>
            ...
            <div className="flex flex-col items-center justify-center py-24 text-center">
              <div className="bg-white p-10 rounded-[2.5rem] shadow-sm border border-gray-100">
                ...
                <p className="text-xl font-bold text-gray-400">
                  No hay productos disponibles en <span className="text-[#497eda]">{term.name}</span>
                </p>
              </div>
            </div>
          )}
