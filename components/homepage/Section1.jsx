        ...
        <section className="container max-w-full flex items-center justify-center bg-[#EEEDED] py-10">
            ...
            <div className=" h-full m-auto lg:w-3/5">
                ...
                <div className="grid grid-cols-2 w-full mt-4 items-center lg:mt-10">
                    ...
                    <Button className={`grid grid-cols-10 mx-auto gap-x-0 lg:mx-0 ${styles.catalbtn}`}>

                        <span className="col-span-9 text-sm px-0.5 font-bold whitespace-normal text-start lg:text-2xl md:w-3/4 md:px-0">¡Echa un vistazo a nuestros productos!</span>
                    ...
                    <Button className={`grid grid-cols-12 mx-auto gap-x-0 lg:mx-0 ${styles.contactbtn}`}>
