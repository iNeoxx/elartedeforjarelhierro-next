  ...
  return (
    <section className="relative container max-w-full py-20 lg:py-32 bg-white overflow-hidden">
      ...
      <div className="container max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-stretch gap-12">
        ...
        <div className="relative w-full lg:w-1/2 flex flex-col justify-between gap-8 p-2 lg:p-0">
          
          {/* ESQUINAS DECORATIVAS PARA MOBILE */}
          <div className="absolute -top-4 -left-4 w-16 h-16 border-t-8 border-l-8 border-[#497EDA] rounded-tl-[2rem] -z-10 lg:hidden" />
          <div className="absolute -bottom-4 -right-4 w-16 h-16 border-b-8 border-r-8 border-[#C93400] rounded-br-[2rem] -z-10 lg:hidden" />
