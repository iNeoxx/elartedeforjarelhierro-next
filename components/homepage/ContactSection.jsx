...
export default function ContactSection() {
  ...
  // Clases renovadas para un look más "Clean" y Premium
  ...
  return (
    <div className="w-full bg-white rounded-[2.5rem] overflow-hidden">
      <div className="flex flex-col lg:flex-row">
        ...
        {/* LADO IZQUIERDO: Info de contacto visual */}
        <div className="hidden lg:flex w-1/3 bg-[#497EDA] p-12 flex-col justify-between text-white">
          <div>
            <h3 className="text-3xl font-black tracking-tighter mb-4 uppercase">¿Listo para empezar?</h3>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm font-bold tracking-wider">elartedeforjar@gmail.com</span>
            </div>
            <div className="flex items-center gap-4">
              <div className="bg-white/20 p-3 rounded-xl">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-sm font-bold tracking-wider">Sardinal de Carrillo, Guanacaste</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 p-8 lg:p-16">
          <form ref={formRef} onSubmit={sendEmail} className="w-full">
            ...
            {/* ReCAPTCHA */}
            <div className="flex justify-center md:justify-start mt-8 grayscale hover:grayscale-0 transition-all duration-500">
